...
// Retorna uma lista de contas de despesas (nova lista, formato amigável)
function getContasDespesas() {
  return [
    "119 - AGUA E ESGOTO",
    "377 - AGUA MINERAL",
    "344 - ALMOCO, CAFE E LANCHES",
    "117 - ALUGUEIS DE IMOVEIS",
    "302 - BRINDE, DOAÇÃO E BONIFICAÇÃO",
    "213 - BRINDES",
    "321 - CDL",
    "108 - COMBUSTIVEIS",
    "284 - COMISSAO VENDEDORES",
    "285 - COMISSOES OPERADOR DE CAIXA",
    "5 - COMPRAS A PRAZO",
    "248 - CONSULTORIA E MARKETING",
    "205 - CONTRIBUICAO SINDICAL",
    "141 - CSLL",
    "199 - CURSOS E TREINAMENTOS",
    "317 - DARF INSS",
    "347 - DECORACAO E ORNAMENTACAO LOJA",
    "106 - DESPESAS BANCARIAS",
    "385 - DESPESAS DIVERSAS",
    "10 - DESPESAS FINANCEIRAS",
    "154 - ECAD",
    "133 - EMBALAGENS",
    "210 - ENERGIA ELETRICA",
    "249 - ENTREGAS",
    "203 - ESTAGIARIOS E APRENDIZES",
    "370 - EXAME MEDICO ADMISSIONAL/DEMISSIONAL",
    "189 - FERIAS",
    "209 - FGTS",
    "158 - FRETES",
    "329 - GASTOS COM TECNICO DE INFORMATICA TERCEIRIZADO",
    "342 - HONORARIO CONTADOR",
    "318 - IMPOSTO ESTADUAL",
    "316 - IMPULSIONAMENTO NO FACEBOOK",
    "310 - INTERNET",
    "125 - IPTU",
    "120 - IRPJ",
    "110 - MANUTENÇÃO DE MAQUINAS E EQUIPAMENTOS",
    "156 - MANUTENÇÃO E REPAROS PREDIAL",
    "118 - MATERIAIS DE EXPEDIENTE",
    "105 - MATERIAIS DE LIMPEZA",
    "312 - MATERIAL DE INFORMÁTICA",
    "212 - MENSALIDADE SISTEMA INFORMATICA",
    "146 - MONITORAMENTO E VIGILANCIA",
    "320 - MONTAGEM LOJA/REFORMA",
    "351 - MOVEIS, UTENSILIOS E BENS",
    "192 - MULTA RESCISORIA",
    "371 - MULTA TRABALHISTAS",
    "352 - PAGAMENTO EMPRESTIMO BANCO",
    "271 - PROPAGANDA E ANUNCIOS",
    "9 - RECEITAS FINANCEIRAS",
    "191 - RESCISOES CONTRATUAIS",
    "357 - SACOLAS",
    "360 - SALARIO ASSISTENTE DE MARKETING",
    "326 - SALARIO ESTOQUISTA",
    "325 - SALARIO GERENTE",
    "372 - SALARIO MATERNIDADE",
    "324 - SALARIO OPERADORES DE CAIXA",
    "327 - SALARIO SERVIÇOS GERAIS",
    "323 - SALARIO VENDEDORES",
    "266 - SERVICOS DE COBRANÇA",
    "322 - TAXA ADMINISTRATIVA GT",
    "341 - TAXAS ADMINISTRATIVAS CARTOES/TEF",
    "13 - TAXAS DE CARTAO",
    "290 - TELEFONE CELULAR",
    "289 - TELEFONE FIXO",
    "201 - UNIFORMES",
